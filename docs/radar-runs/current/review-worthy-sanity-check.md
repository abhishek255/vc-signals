# Review-Worthy Company Sanity Check

Run generated: `2026-06-02T01:29:18Z`
Sanity check performed: June 1, 2026 ET
...
- 6 / 8 have reasonably strong product/commercial proof.
- 2 / 8 need extra identity caution because the evidence set includes noisy name-collision links.
- 0 / 8 should be treated as owner-ready without founder/team and stage/headcount/funding checks.
...
1. Check founder/team on the official website, LinkedIn, Product Hunt maker pages, GitHub, or X.
2. Check stage/headcount/funding through public snippets, Crunchbase-style web checks, YC/company pages, or LinkedIn manual review.
3. Check customer/commercial proof on pricing, docs, customers, case studies, changelog, downloads, or careers pages.
4. Promote only if the official domain and operator/company identity stay consistent.

## Cleanup Notes

- Tighten evidence URL filtering to drop localhost URLs, unrelated same-name sites, and legacy projects that share the product name.
- Validate GitHub evidence URLs before showing them as support.
- Keep these rows in `research deeper`; the strict Assign Owner gate is still working.
